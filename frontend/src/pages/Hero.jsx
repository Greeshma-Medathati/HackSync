...
export default function Hero() {
  ...
  const stats = [
    {
      number: "Manage Teams ",
      description: "Simplify registrations and team formation"
    },
    {
      number: " Support Innovation",
      description: "Provide resources and mentorship"
    },
    {
      number: "Optimize Judging ",
      description: "Ensure smooth evaluations and prize distribution"
    }
  ]
        ...
        <div className="max-w-4xl mx-auto space-y-8 sm:space-y-12">
          ...
          <div className="text-center space-y-6 sm:space-y-8">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-white font-tt-commons animate-fade-in-up">
              Hack<span className="text-[#01C38D]">Sync</span>
            </h1>
